...
<%@page import="com.se.pojo.Data"%>
<%@page import="com.se.dao.DataDAO"%>
		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					...
					<li class="active"><a class="" href="view?type=get"> <span>View Files</span>
					</a></li>
						...
						<div class="panel-body" style='min-height:600px;'>
							...
							<%
								...
								if (data==null || data.size()==0) {
									%>
										<h3>You don't have any data stored on Cloud</h3>
									<%
								} else {
									%>
											...
											%>
													<form action='view' method=post>
														<input type=hidden name='file' value='<%=d.getFilename()%>'/>
														<input type=hidden name='type' value='download'/>
														<div class='col-md-3' style='padding:30px;'>
																<img src='img/file.png' width=100 />
																<br/>
																<%=d.getFilename().replace(d.getDid()+"_","") %>
																<br/>
																<%=sdf.format(d.getEntry_time()) %>
																<br/><br/>
																 
																<input type=submit value='Download File' class='btn btn-success' /> &nbsp;&nbsp;&nbsp;&nbsp;
																<a class='btn btn-danger' href='view?type=delete&did=<%=d.getDid()%>&file=<%=d.getFilename()%>'>Delete File</a>`
															</div>
													</form>
