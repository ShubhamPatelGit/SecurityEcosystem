		...
		<aside>
			<div id="sidebar" class="nav-collapse ">
				...
				<ul class="sidebar-menu">
					...
					<li class="sub-menu"><a href="javascript:;" class=""> <span>Forms</span>
				...
				<div class="col-md-12">
					...
					<form action='account' method=post class='col-md-6'>
						...
						&nbsp;&nbsp;&nbsp;&nbsp; <input type="radio"
							...
							Enter your Mobile number </label> <input type=text class='form-control'
							name='mobile' placeholder='Mobile number'
							value='<%=user.getMobile()%>' /> <br /> <label> Enter
							your Address </label>
						<textarea class='form-control' name='addr' placeholder='Address'><%=user.getAddr()%></textarea>
