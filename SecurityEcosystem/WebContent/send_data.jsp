				...
				<div class="col-md-12">
					<section class="panel">
						...
						<div class="panel-body" style='min-height:600px;'>
							...
							<form action='dt' method=post class='col-md-6' id='frm' >
								<label>Enter confidential data</label>
								<input type=text id='data_c' class='form-control' placeholder="Some Data" required="required">
								<input id='chidden' type=hidden name='data_c' value='' />
								<br/>
								<label>Enter non-confidential data</label>
								<input type=text name='data_nc' class='form-control' placeholder="Some Data" required="required">
								<br/>
								<input type=button id='sbtn' value='Send Data' class='btn btn-primary'/>>
							</form>
